...
<?php $showMonitoring = in_array($_SESSION['role'], ['superadmin', 'admin_gudang_aset']) && $warehouse_type === 'GUDANG_ASET'; ?>
...
<div class="container-fluid px-4">
    ...
    <ul class="nav nav-tabs mb-3">
        <li class="nav-item">
            <a class="nav-link active" href="index.php?page=warehouse_dashboard">
                <i class="fas fa-inbox me-1"></i>Request Masuk
                <span class="badge bg-primary ms-1"><?php echo count($requests); ?></span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="index.php?page=warehouse_asset_monitoring">
