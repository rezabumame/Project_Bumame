...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center page-header-container">
        <div>
            <h1 class="page-header-title">Edit Staff</h1>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <form action="index.php?page=man_power_update" method="POST">
                <input type="hidden" name="id" value="<?php echo $man_power['id']; ?>">
                
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="name" class="form-label">Full Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="name" name="name" value="<?php echo htmlspecialchars($man_power['name']); ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" class="form-control" id="email" name="email" value="<?php echo htmlspecialchars($man_power['email']); ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-check form-switch form-check-inline mt-2">
                            ...
                            <input class="form-check-input" type="checkbox" id="status_switch" name="status" value="Internal" <?php echo (strcasecmp($man_power['status'], 'internal') == 0) ? 'checked' : ''; ?>>
                            <label class="form-check-label fw-bold" for="status_switch" id="status_label">
                                <?php echo (strcasecmp($man_power['status'], 'internal') == 0) ? 'Internal' : 'External'; ?>
                            </label>
                        </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" <?php echo ($man_power['is_active']) ? 'checked' : ''; ?>>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary px-4">Update Man Power</button>
                </div>
            </form>
        </div>
    </div>
